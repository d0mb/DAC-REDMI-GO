...
### DAC Redmi Go Project Skills

| Skill                        | Description                                                 |
| ---------------------------- | ----------------------------------------------------------- |
| `dac-builder`                | Compilação e empacotamento de APK C++ e transmissor PC      |
| `dac-screencap-and-control`  | Captura de tela ao vivo e controle remoto ADB do celular    |
| `dac-airplay-diagnostics`    | Diagnóstico de handshake Apple AirPlay 2 e streaming ALAC   |
